...
- (id)initWithService:(NSString *)service accessGroup:(NSString *)accessGroup {
  return [self initWithService:service accessGroup:accessGroup accessibility:FXKeychainAccessibleWhenUnlocked];
}

- (id)initWithService:(NSString *)service accessGroup:(NSString *)accessGroup accessibility:(FXKeychainAccess)accessibility {
  if ((self = [super init])) {
...
- (BOOL)setObject:(id)object forKey:(id)key {
  ...
  if ([(id)object isKindOfClass:[NSString class]]) {
    ...
    if (![object hasPrefix:@"bplist"] ||
        ![NSPropertyListSerialization propertyListWithData:[object dataUsingEncoding:NSUTF8StringEncoding]
